...
export * from './lib/fhir-chart-legend/dataset-tags-legend/dataset-tags.service';
export * from './lib/fhir-chart-legend/dataset-tags-legend/dataset-tags-legend.component';
