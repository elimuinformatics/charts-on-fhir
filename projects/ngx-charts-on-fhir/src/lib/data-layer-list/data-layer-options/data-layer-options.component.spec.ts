...
import { ManagedDataLayer } from 'ngx-charts-on-fhir';
...
describe('DataLayerOptionsComponent', () => {
  ...
  it('when onDatasetsChange called it should emit event', () => {
    let dataset: any = [
      {
    ...
    // const change= new EventEmitter<ManagedDataLayer>();
